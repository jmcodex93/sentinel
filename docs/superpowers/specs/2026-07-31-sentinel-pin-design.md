...
**Contexto**: cierra la expansión de Tools (v1.30 quick-wins → v1.31 Batch Rename → v1.32-v1.34 matwire → **v1.35 este spec**). Se concibió como la primera de dos capas de "puntos de retorno"; la segunda (la red automática) **se descartó** al brainstormear la v1.36 — ver "Fuera de alcance" al final. La v1.36 pasó a ser [Sentinel Variants](2026-08-05-sentinel-variants-design.md), que resuelve un verbo distinto: elegir entre alternativas, no volver atrás.
...
- **La capa automática** (snapshot de documento antes de operaciones destructivas de Sentinel): mecanismo distinto y palabra distinta — ahí sí sería un punto de retorno, no una alternativa. **DESCARTADA en el brainstorm de la v1.36** (2026-08-05): al preguntar en qué momento real le había faltado, la respuesta fue "nunca — es prevención", así que un subsistema entero para un problema no tenido contradice las reglas del proyecto. La v1.36 es [Sentinel Variants](2026-08-05-sentinel-variants-design.md). La auditoría del undo en C4D vivo, que SÍ tiene evidencia, queda como tarea de fondo sin versión propia.
