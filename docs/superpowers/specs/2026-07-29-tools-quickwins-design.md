...
**Fecha**: 2026-07-29
**Estado**: implementado en rama `feat/tools-quickwins` (commits 6c97248..d37366f), pytest 946 + vitest 151 verdes, pendiente verificación live (decisiones del usuario: limpiadores como botones de Tools, no QC; empty null = sin hijos y sin tags, cascada; material tags = rotos + duplicados exactos; keyframes = todas las pistas de selección+hijos; render notify ON con umbral 30s)
