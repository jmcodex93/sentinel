...
- **SPC sobre-promete.** El tamaño no caza todos los denoiser-fails y puede dar falsos positivos en varianza de compresión EXR. Mitigado: reformulado como "marca anomalías de tamaño", no "cataches corruption"; ventana rodante diferida.
