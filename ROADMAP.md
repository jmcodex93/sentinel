...
- **Fase 6.1-6.4 (pendientes)**: resto de la migración del panel nativo a la SPA — con el spike de dock 6.0 VERDE, candidatas a definir: paridad de pestañas Render/Versions/Tools, retiro gradual del panel nativo
